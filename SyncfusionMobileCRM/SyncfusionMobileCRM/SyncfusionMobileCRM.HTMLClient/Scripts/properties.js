...
var themes = {
	"flat": "../themes/default-theme/ej.widgets.all.css",
    "flatdark": "../themes/flat-azure-dark/ej.widgets.all.css",
    "azure": "../themes/default-theme/ej.widgets.all.css",
    "azuredark": "../themes/flat-azure-dark/ej.widgets.all.css",
    "lime": "../themes/flat-lime/ej.widgets.all.css",
    "limedark": "../themes/flat-lime-dark/ej.widgets.all.css",
    "saffron": "../themes/flat-saffron/ej.widgets.all.css",
    "saffrondark": "../themes/flat-saffron-dark/ej.widgets.all.css",
	"gradient": "../themes/gradient-azure/ej.widgets.all.css",
    "gradientdark": "../themes/gradient-azure-dark/ej.widgets.all.css",
    "gradientazure": "../themes/gradient-azure/ej.widgets.all.css",
    "gradientazuredark": "../themes/gradient-azure-dark/ej.widgets.all.css",
    "gradientlime": "../themes/gradient-lime/ej.widgets.all.css",
    "gradientlimedark": "../themes/gradient-lime-dark/ej.widgets.all.css",
    "gradientsaffron": "../themes/gradient-saffron/ej.widgets.all.css",
    "gradientsaffrondark": "../themes/gradient-saffron-dark/ej.widgets.all.css"
};
...
function adjustpopupposition(args) {
    ...
    var height = $("#selectControls_dropdown").height();
    $("#selectControls_popup").css("top", (offset.top + height) + "px");
    var left = $("#selectControls_popup").width() + offset.left;
    if (left > $(".content-container-fluid").width())
        left = (offset.left + $("#selectControls_dropdown").width()) - $("#selectControls_popup").width() - 10;
